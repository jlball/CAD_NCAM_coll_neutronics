...
def analyse_statepoint(directory, sp_name = "statepoint.100.h5", plot=True):
    ...
    fig.tight_layout()
    fig.savefig(f'{directory}/XY_neutron_flux.png', dpi=300)
    ...
    dose_fig.savefig(f'{directory}/XY_neutron_dose_rate.png', dpi=300)
    ...
    photon_dose_fig.savefig(f'{directory}/XY_photon_dose_rate.png', dpi=300)
    ...
    det_spec_fig.savefig(f'{directory}/detector_neutron_spectrum.png', dpi=300)
